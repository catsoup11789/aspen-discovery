...
- Add Theme Options in Branded App Settings to allow configuring a single theme for all locations to use legacy configurations. ([DIS-2820](https://aspen-discovery.atlassian.net/browse/DIS-2820)) (*KK*)

<div markdown="1" class="settings">

##### New Settings
- Aspen LiDA > Themes
- Aspen LiDA > Branded App Settings > Theme Settings
